...
# figure mi tick setting
ax.xaxis.set_major_locator(MultipleLocator(2)) ## x값이 5의 배수일 때마다 메인 눈금 표시
ax.xaxis.set_major_formatter('{x:.0f}') ## 메인 눈금이 표시될 형식
ax.xaxis.set_minor_locator(MultipleLocator(1)) ## 서브 눈금은 x값이 1의 배수인 경우마다 표시
