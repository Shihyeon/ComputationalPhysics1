...
s1.update([1, 2, 3])    # set s1에 원소 {1}, {2}, {3} 추가oh-my-posh init pwsh --config 'C:\Users\admin\AppData\Local\Programs\oh-my-posh\themes\catppuccin.omp.json' | Invoke-Expression